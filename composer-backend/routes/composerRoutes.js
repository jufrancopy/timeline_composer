...
module.exports = (prisma, transporter) => {
    ...
    const authenticateJWT = (req, res, next) => {
        console.log('[ComposerRoutes] Middleware authenticateJWT activado.');
    ...
    router.get('/', authenticateJWT, async (req, res) => {
        console.log('[ComposerRoutes] ---- INICIO DE RUTA GET / ----');
        console.log('[ComposerRoutes] Ruta GET / (todos los compositores) activada.');
        try {
