      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-500/20 to-indigo-500/20 p-8 pb-6">
            <img src={logo} alt="Logo EduPlatForm" className="w-32 h-32 bg-gradient-to-br from-blue-400 to-indigo-400 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg transform hover:scale-105 transition-transform duration-300 p-2" />
